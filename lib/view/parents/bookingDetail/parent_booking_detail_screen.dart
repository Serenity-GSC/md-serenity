...
class ParentBookingDetailScreen extends StatefulWidget {
  ...
  const ParentBookingDetailScreen(
      {Key? key,
  ...
  @override
  _ParentBookingDetailScreenState createState() =>
      _ParentBookingDetailScreenState();
}

class _ParentBookingDetailScreenState extends State<ParentBookingDetailScreen> {
        ...
        child: Column(
          children: [
            ...
            new CircularPercentIndicator(
              radius: 45.0,
              lineWidth: 10.0,
              percent: widget.evaluation / 10,
              center: new Text('${(widget.evaluation / 10) * 100}' + '\%'),
              progressColor: widget.evaluation <= 4
                  ? Colors.green
                  : widget.evaluation > 4 && widget.evaluation <= 6
                      ? Colors.yellow
                      : widget.evaluation > 6
                          ? Colors.red
                          : Colors.blue,
