  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
          color:
              isSelected ? Color.fromARGB(255, 7, 224, 80) : Colors.transparent,
    ...
    return GestureDetector(
      onTap: () {
        Navigator.of(context)
            .push(MaterialPageRoute(builder: (context) => ZoomEvent()));
      },
      child: Container(
        height: 100,
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Text(
                      desc,
                      style:
                          GoogleFonts.sora(color: Colors.white, fontSize: 15),
                    ),
                    SizedBox(
                      height: 8,
                    ),
